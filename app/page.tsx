      ...
      <section className="projects" id="projects">
        <div className="shell projects-grid"><div><p className="section-number">02 / {t.projectsLabel}</p><h2>{t.projectsTitle}</h2><p>{t.projectsBody}</p></div>
          <div className="project-stack">
            ...
            <a href="/policy-windows-explorer/" className="project-card orange"><span>03 · Proof of concept</span><h3>AI Policy Windows<br />Explorer</h3><p>A public prototype for prioritizing talent pipelines, policymaker capacity, and media momentum in AI governance.</p><b>↗</b></a>
          </div>
        </div>
      </section>
